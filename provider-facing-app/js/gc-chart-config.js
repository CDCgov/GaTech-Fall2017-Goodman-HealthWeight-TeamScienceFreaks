...
(function ($, GC) {
   "use strict";
    ...
    var settings = {
        ...
        percentiles : [0.05, 0.10, 0.25, 0.5, 0.75,0.85, 0.90, 0.95, 1.10, 1.20, 1.30, 1.40, 1.50, 1.60
        , 1.70, 1.80, 1.90, 2.00], // or [0.03, 0.15, 0.5, 0.85, 0.97]
        percentiles1 : [0.05, 0.10, 0.25, 0.5, 0.75,0.85, 0.90, 0.95],
        // Minimal time range to observe in millisecconds
        minTimeInterval : GC.Constants.TIME.WEEK * 6,
        
        pctz      : "pct", // "pct" or "z"
        metrics   : "eng", // "metric" or "eng"
    ...
    function setChartSettingsColors (chartName, baseColor1, baseColor2, baseColor3) {
        readOnlySettings[chartName].color = baseColor1;
        readOnlySettings[chartName].fillRegion.fill = baseColor1;
        readOnlySettings[chartName].fillRegion85.fill = baseColor2;
        readOnlySettings[chartName].fillRegion95.fill = baseColor3;
        readOnlySettings[chartName].lines.stroke = "#000000" //GC.Util.darken(baseColor1, 80);
        readOnlySettings[chartName].axis.stroke = GC.Util.darken(baseColor1, 90);
        readOnlySettings[chartName].axisLabels.fill = GC.Util.darken(baseColor1, 70);
        readOnlySettings[chartName].pointsColor = GC.Util.darken(baseColor1, 70);
        readOnlySettings[chartName].problemRegion.fillColor = baseColor1;
    }
    ...
    setChartSettingsColors("bodyMassChart", "#7FFF00", "#FFFF00", "#FF0000");
