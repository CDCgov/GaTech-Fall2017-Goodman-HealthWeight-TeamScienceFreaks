...
(function($) {
    ...
    if (!window.sessionStorage.getItem('fhir_url_global'))
    {
        ...
        window.sessionStorage.setItem('fhir_url_global','http://127.0.0.1:8080/gt-healthy-weight/baseDstu2' );
    }


    var fhir_url = window.sessionStorage.getItem('fhir_url_global')  + '/';

    //Change the title to match the questionnaire that loads in the Healthy Habit History Tab
    var ChildHealthyEatingQuestionnaireCall = (function ()
      {
          //GET http://52.72.172.54:8080/fhir/baseDstu2/Questionnaire?title=Healthy Habits Questionnaire
            ...
            $.ajax({
                ...
                url: fhir_url +'Questionnaire?title=Obesity Healthy Habits Questionnaire',            
                dataType: 'json',
