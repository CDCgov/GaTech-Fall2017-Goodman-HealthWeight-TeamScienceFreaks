...
(function(NS) {
    ...
    function getCurvesData( dataSet, startAge, endAge ) {
        ...
        var gender   = GC.App.getGender(),
            ...
            pcts1    = GC.Preferences.prop("percentiles1"),
            label;
        ...
        if (set.type == "LMS" && set.name == "CDC_BMI") {     //Show the percentile lines for BMI up to 200
        ...
        else if(set.type == "LMS" && set.name != "CDC_BMI") {     //Show the percentile lines for Height and Weight up to 95
            $.each(pcts1, function (i, pct) {
                data1[i] = {
                    label: pct * 100,
                    data: GC.generateCurveSeries(set, gender, pct, startAge, endAge)
                };
